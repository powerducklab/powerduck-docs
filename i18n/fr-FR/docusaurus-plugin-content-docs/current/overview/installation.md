...
Le client de bureau peut être évalué librement. Il est vendu sous licence **perpétuelle** après un achat unique, sans abonnement. La clé de licence est générée à l'achat et affichée une seule fois. L'hébergement cloud est un service par abonnement distinct. Voir [Facturation Cloud](/docs/cloud/billing) pour la distinction.

Ensuite, passez au [Démarrage rapide](/docs/overview/quickstart).
