...
Die Gesamtheit der Tore steht in [Zugriffskontrolle](/docs/cloud/access-control).
...
Siehe auch: [Zugriffskontrolle](/docs/cloud/access-control)、[Dokumente und Versionen](/docs/cloud/documents-versions).
