...
O conjunto completo de portas está em [Controlo de acesso](/docs/cloud/access-control).
...
Veja também: [Controlo de acesso](/docs/cloud/access-control)、[Documentos e versões](/docs/cloud/documents-versions).
