...
sidebar_position: 1
title: "Introduction"
description: "Schema-aware Monaco editor for JSON, YAML, and JavaScript. Driven by any JSON Schema with ghost text, popup completion, enum dropdowns, example auto-fill, and schema diagnostics."
keywords: ["schema-editor", "powerduck", "Monaco", "JSON Schema", "editor", "introduction"]
---

# @powerduck/schema-editor

Schema-aware Monaco editor for JSON, YAML, and JavaScript. Driven by any JSON
Schema with ghost text, popup completion, enum dropdowns, example auto-fill,
and schema diagnostics.

- **Package name:** `@powerduck/schema-editor`
- **Version:** <img src="https://img.shields.io/npm/v/@powerduck/schema-editor"/>
- **License:** MIT
...
- **Light/dark themes** — `powerduck-light` and `powerduck-dark`
